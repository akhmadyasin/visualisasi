...
MONGO_URI = "mongodb+srv://yasin:yasin27062004@cluster0.8khbyuv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"

def save_to_mongo(data):
    if data:
        client = MongoClient(MONGO_URI)
        db = client['capstone']          # nama database sama seperti sebelumnya
        collection = db['data']          # nama koleksi juga sama
